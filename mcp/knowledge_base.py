...
class KnowledgeBase:
    ...
    def __init__(
        ...
        # Embeddings are supplied explicitly by the application.  ChromaDB is
        # the vector store; it no longer chooses the default English model.
        ...
        # 如果知识库为空，导入默认文档
        if bootstrap_defaults and self._collection.count() == 0:
